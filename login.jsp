        ...
        <div class="main">
            ...
            <form method="post" action="check.jsp">
                <div class="left_rabbit">
                    <img src="image/lookL.png" alt="L">
                </div>
                <div class="right_rabbit">
                    <img src="image/lookR.png" alt="R">
                </div>
                <h1>LOG IN</h1>
                <!--帳號-->
                <div class="fill">
                    <input type="email" name="user_email" placeholder="E-mail" id="user_email" maxlength="40" size="30" required="">
                </div>
                <!--密碼-->
                <div class="fill">
                     <input type="password" name="user_password" placeholder="password" size="30" maxlength="20" id="user_password" required="">
                </div>
