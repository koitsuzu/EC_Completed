...
<html lang="en">
	...
	%>
		...
		<table>
			<tr>
			<td>class:</td>
			<td><input type="text" name="P_class" placeholder=""  maxlength="40" size="30" required=""></td>
			</tr>

			<tr>
			<td>name:</td>
			<td><input type="text" name="P_name" placeholder=""  maxlength="40" size="30" required=""></td>
			</tr>

			<tr>
			<td>img:</td>
			<td><input type="text" name="P_img" placeholder=""  maxlength="40" size="30" required=""></td>
			</tr>
			
			<tr>
			<td>detial:</td>
			<td><input type="text" name="P_detail" placeholder=""  maxlength="200" size="30" required=""></td>
			</tr>	
			<tr>
			<td>NT$:</td>
			<td><input type="text" name="P_price" placeholder=""  maxlength="40" size="30" required="">	
			</td>
			</tr>
			...
			<tr>
			<td>quantity:</td>
			<td><input type="text" name="P_qty" placeholder=""  maxlength="40" size="30" required=""></td>
			</tr>		
		</table>
			<button type="submit" class="btn_cart" onclick="javascript:alert('新增商品')">新增商品</button>	
		</form>
		</div>
