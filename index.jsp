...
<!-- 首頁動態圖 文字 -->
  <div>
      <div id="cover" class="coverflow">
        <a href='yokan.jsp'><img src="image/ran1.jpg" width="1600px" height="650px"></a>
        <a href="yokan.jsp"><img src="image/ran2.jpg" width="1600px" height="650px"></a>
        <a href="yokan.jsp"><img src="image/ran3.jpg" width="1600px" height="650px"></a>
      </div>
  </div>
...
<div class="fade">
    <div class="chimi"><h1>---Welcome to Chinmi---</h1></div>
</div>

<!-- 最新資訊 -->
<div class="news">
    <div class="flower1"><img src="image/flower1.png" height="280px" ></div>
    <div class="flower2"><img src="image/flower2.png" height="150px" ></div>
    <div class="news1">       
        <div class="news2">
            <h3>最新消息<br></h3>
            <p>------------------------------------</p>
            <b>
                <p>『月兔禮盒』將於7/1晚上6點開放訂購</p>
                <p>三週年優惠 全館5/9~6/18免運</p>
                <p>客製化禮盒開放訂購中</p>
            </b>
        </div>
    </div>
    
    <div class="flower3"><img src="image/flower1.png" height="150px"></div>
    <div class="flower4"><img src="image/flower2.png" height="260px"></div>
</div>
<!-- best兔 -->
 <script>
...
<div class="best">
   <div class="best"><img src="image/best.png" alt=""> </div>
   <div class="bigger">     
       <%
       int i = 1;
       while (rs.next() && i <= 5) {
   ...
   %>
            <div class="best<%=i %>">
               <form id="form" action="good.jsp">
                    <div class="bestt<%=i %>">
                        <img src="image/<%=rs.getString(4) %>" onclick="selectOption('<%=PID%>')" style="border-radius:50%" height="200px" width="200px">
                    </div>
...
<script>
    function openNav() {
      document.getElementById("car").style.width = "430px";
