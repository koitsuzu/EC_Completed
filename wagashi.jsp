...
%>
    ...
    <section>
        <img src="image/wagashi.png" class="head">
         <div class="shape-ex2">わがし<br><font size="100">-wagashi-</font></div>
        
    </section>
    <div class="fuku">——————— 禮盒 ———————</div>

    <main>
            <form id="form" class="container x" action="good.jsp" method="post">
 <%
                    sql = "SELECT * FROM `product` Where `Class`='禮盒';";
                    ResultSet rs = con.createStatement().executeQuery(sql);
                    //Step 5：進行資料的處理
                    while (rs.next()) {
