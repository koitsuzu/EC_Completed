...
<head>
    ...
    <link rel="stylesheet" href="assets/yokan.css">
...
%>
    ...
    <section>
        <img src="image/yokan.png" class="head">
        <div class="shape-ex2">ようかん<br><font size="100">-Yo kan-</font></div>
        
    </section>
    <div class="fuku">——————— 羊羹 ———————</div>

    <main>
            <form class="container x" id="form" action="good.jsp" method="post">
        <%
                    sql = "SELECT * FROM `product` Where `Class`='羊羹';";
                    ResultSet rs = con.createStatement().executeQuery(sql);
                    //Step 5：進行資料的處理
                    while (rs.next()) {
