...
<head>
    ...
    <link rel="stylesheet" href="assets/namagashi.css">
...
%>
    ...
    <section>
        <img src="image/namagashi.png" class="head">
        <div class="shape-ex2">なまがし<br><font size="100">-namagashi-</font></div>
        
    </section>
    <div class="fuku">—————— 上生菓子 ——————</div>
    <main>
        <form id="form" class="container x" action="good.jsp" method="post">
   <%
                    sql = "SELECT * FROM `product` Where `Class`='上生菓子';";
                    ResultSet rs = con.createStatement().executeQuery(sql);
                    //Step 5：進行資料的處理
                    while (rs.next()) {
