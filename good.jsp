...
%>
    <div class="main">
		...
		<%		
            ...
            <p class="price">NT$<%=rs.getString(6)%></p>
            <p>
                <%=rs.getString(5)%></p>
            <div>
                <form action="addcart.jsp">
                    <div class="btn_set">
                        <div class="btn_font">
						    <input type="hidden" name="PID" value="<%= PID %>">
							<input type="hidden" name="IMG" value="<%= rs.getString(4) %>">
            ...
            <p><font size="5px" color="#A39274">庫存:<%=rs.getString(7)%>個</font></p>
			  <form action="ReviseP.jsp">
                                        <input type="hidden" name="PID" value="<%= PID %>">
                                        <button type="submit" style="
